...
![ID3 screen](images/id3.png)

## Purpose
This screen presents conversation analysis results for a selected session, including summary metrics and AI insights.
...
- Shared elements like the logo and top bar appear across multiple screens.
